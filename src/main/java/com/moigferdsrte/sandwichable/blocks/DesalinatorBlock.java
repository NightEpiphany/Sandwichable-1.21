...
import com.moigferdsrte.sandwichable.blocks.extra.BucketFluidloggable;
...
public class DesalinatorBlock extends ModelBlockWithEntity implements Waterloggable, BucketFluidloggable {
    ...
    public DesalinatorBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        if (itemStack.contains(CUSTOM_NAME)) {
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if (blockEntity instanceof DesalinatorBlockEntity desalinatorBlockEntity) {
                desalinatorBlockEntity.customName = itemStack.getName();
            }
        }
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, BlocksRegistry.DESALINATOR_BLOCKENTITY, DesalinatorBlockEntity::tick);
    }
