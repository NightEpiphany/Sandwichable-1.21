...
public class SandwichTableBlock extends Block implements BlockEntityProvider, SneakInteractable {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (!world.isClient() && blockEntity instanceof SandwichTableBlockEntity) {
            ...
            if (sBlockEntity == null) return ActionResult.PASS;
            sBlockEntity.getSandwich()
                    .interact(
                            world,
                            new Vec3d(pos.getX()+0.5, pos.getY(), pos.getZ()+0.5),
                            player,
                            player.preferredHand == null ? Hand.MAIN_HAND : player.preferredHand,
                            player.isSneaking(),
    ...
    public void ejectSandwich(World world, BlockPos pos) {
        ...
        if(be instanceof SandwichTableBlockEntity blockEntity) {
