...
public class BottleCrateBlock extends ModelBlockWithEntity {
    ...
    public BottleCrateBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(BottleCrateBlock::new);
    }
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        if (itemStack.contains(CUSTOM_NAME)) {
            ...
            if (blockEntity instanceof BottleCrateBlockEntity bottleCrateBlockEntity) {
                bottleCrateBlockEntity.customName = itemStack.getName();
            }
        }
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, BlocksRegistry.BOTTLECRATE_BLOCKENTITY, BottleCrateBlockEntity::tick);
    }
