...
import com.moigferdsrte.sandwichable.blocks.BottleCrateBlock;
...
public class BottleCrateBlockEntity extends LockableContainerBlockEntity implements ExtendedScreenHandlerFactory<BottleCratePos>, SidedInventory, SyncedBlockEntity {
    ...
    @Override
    public BottleCratePos getScreenOpeningData(ServerPlayerEntity player) {
        return new BottleCratePos(this.pos);
    }
}
