...
public class SandwichableREI implements REIClientPlugin {
    ...
    public void registerDisplays(DisplayRegistry registry) {
        registry.registerRecipeFiller(CuttingRecipe.class, RecipeRegistry.CUTTING_RECIPE, CuttingBoardDisplay::new);
        registry.registerRecipeFiller(ToastingRecipe.class, RecipeRegistry.TOASTING_RECIPE, ToastingDisplay::new);
    }
}
