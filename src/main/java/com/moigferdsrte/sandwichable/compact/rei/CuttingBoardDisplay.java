...
public class CuttingBoardDisplay implements Display {
    ...
    public CuttingBoardDisplay(RecipeEntry<CuttingRecipe> cuttingRecipeRecipeEntry) {
        this(cuttingRecipeRecipeEntry.value().getInput(), cuttingRecipeRecipeEntry.value().getOutputStack());
    }
