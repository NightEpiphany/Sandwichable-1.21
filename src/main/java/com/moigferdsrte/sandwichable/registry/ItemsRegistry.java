...
public final class ItemsRegistry {
    public static final FoodComponent BREADSLICE = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.5F).build();
    public static final FoodComponent TOASTEDBREADSLICE = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.6F).build();
    public static final FoodComponent ANCIENTGRAINBREAD = (new FoodComponent.Builder()).build();
    public static final FoodComponent LETTUCEHEAD = (new FoodComponent.Builder()).nutrition(5).saturationModifier(0.8F).snack().build();
    public static final FoodComponent LETTUCELEAF = (new FoodComponent.Builder()).nutrition(1).saturationModifier(0.3F).snack().build();
    public static final FoodComponent TOMATO_FOOD = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.42F).build();
    public static final FoodComponent TOMATOSLICE = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.7F).snack().build();
    public static final FoodComponent COOKEDTOMATOSLICE = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.7F).snack().build();
    public static final FoodComponent CUCUMBER_FOOD = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.6F).build();
    public static final FoodComponent PICKLEDCUCUMBER = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.6F).build();
    public static final FoodComponent PICKLECHIPS = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.5F).snack().build();
    public static final FoodComponent ONION_FOOD = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.8F).build();
    public static final FoodComponent CHOPPEDONION = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.6F).snack().build();
    public static final FoodComponent COOKEDCHOPPEDONION = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.6F).snack().build();
    public static final FoodComponent BACON = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.7F).build();
    public static final FoodComponent PORKCUTS = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.3F).build();
    public static final FoodComponent COOKEDPORKCUTS = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.6F).build();
    public static final FoodComponent RAWCHICKFILET = (new FoodComponent.Builder()).nutrition(1).saturationModifier(0.2F).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 300, 0), 0.3F).build();
    public static final FoodComponent COOKEDCHICKFILET = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.5F).build();
    public static final FoodComponent RAWCODFILET = (new FoodComponent.Builder()).nutrition(1).saturationModifier(0.2F).build();
    public static final FoodComponent COOKEDCODFILET = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.5F).build();
    public static final FoodComponent RAWSALMONFILET = (new FoodComponent.Builder()).nutrition(1).saturationModifier(0.35F).build();
    public static final FoodComponent COOKEDSALMONFILET = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.8F).build();
    public static final FoodComponent CRIMSONFUNGUS = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.5F).build();
    public static final FoodComponent SLICEDCRIMSONFUNGUS = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.6F).snack().build();
    public static final FoodComponent WARPEDFUNGUS = (new FoodComponent.Builder()).nutrition(5).saturationModifier(0.4F).build();
    public static final FoodComponent SLICEDWARPEDFUNGUS = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.5F).snack().build();
    public static final FoodComponent CHOPPEDCARROT = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.5F).snack().build();
    public static final FoodComponent COOKEDCHOPPEDCARROT = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.6F).snack().build();
    public static final FoodComponent CHOPPEDGOLDCARROT = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.8F).snack().build();
    public static final FoodComponent CHOPPEDBEETROOT = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.6F).snack().build();
    public static final FoodComponent COOKEDCHOPPEDBEETROOT = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.7F).snack().build();
    public static final FoodComponent SWEETBERRYJAM = (new FoodComponent.Builder()).nutrition(5).saturationModifier(0.5F).build();
    public static final FoodComponent GLOWBERRYJAM = (new FoodComponent.Builder()).nutrition(5).saturationModifier(0.5F).build();
    public static final FoodComponent MAYONNAISE_FOOD = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.6F).build();
    public static final FoodComponent APPLESLICES = (new FoodComponent.Builder()).nutrition(2).saturationModifier(0.5F).snack().build();
    public static final FoodComponent GOLDAPPLESLICES = (new FoodComponent.Builder()).nutrition(3).saturationModifier(0.7F).snack().statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 50, 1), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 1200, 0), 1.0F).alwaysEdible().build();
    public static final FoodComponent ENCHANTEDGOLDAPPLESLICES = (new FoodComponent.Builder()).nutrition(4).saturationModifier(0.8F).snack().statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 200, 1), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 3000, 0), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 3000, 0), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 1200, 3), 1.0F).alwaysEdible().build();
    public static final FoodComponent BURNTFOOD = (new FoodComponent.Builder()).nutrition(1).saturationModifier(0.1F).build();
    public static final FoodComponent BURNTMORSEL = (new FoodComponent.Builder()).nutrition(1).saturationModifier(0F).build();
    ...
    public static final Item STONE_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterials.STONE, new Item.Settings().maxCount(1));
    public static final Item IRON_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterials.IRON, new Item.Settings().maxCount(1));
    public static final Item GOLDEN_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterials.GOLD, new Item.Settings().maxCount(1));
    public static final Item DIAMOND_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterials.DIAMOND, new Item.Settings().maxCount(1));
    public static final Item NETHERITE_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterials.NETHERITE, new Item.Settings().maxCount(1).fireproof());
    public static final Item GLASS_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterials.WOOD, new Item.Settings().maxCount(1));
    ...
    public static final Item LETTUCE_SEEDS = new SandwichGreenSeedItem(BlocksRegistry.LETTUCE, new Item.Settings());
    public static final Item TOMATO_SEEDS = new SandwichGreenSeedItem(BlocksRegistry.TOMATOES, new Item.Settings());
    public static final Item CUCUMBER_SEEDS = new SandwichGreenSeedItem(BlocksRegistry.CUCUMBERS, new Item.Settings());
    public static final Item ONION_SEEDS = new SandwichGreenSeedItem(BlocksRegistry.ONIONS, new Item.Settings());
    public static final Item ANCIENT_GRAIN_SEEDS = new SandwichGreenSeedItem(BlocksRegistry.ANCIENT_GRAIN, new Item.Settings());
    ...
    public static final Item MUSHROOM_STEW_SPREAD = new SpreadItem(SpreadRegistry.MUSHROOM_STEW);
    public static final Item RABBIT_STEW_SPREAD = new SpreadItem(SpreadRegistry.RABBIT_STEW);
    public static final Item BEETROOT_SOUP_SPREAD = new SpreadItem(SpreadRegistry.BEETROOT_SOUP);
    public static final Item HONEY_SPREAD = new SpreadItem(SpreadRegistry.HONEY);
    public static final Item SUSPICIOUS_STEW_SPREAD = new SpreadItem(SpreadRegistry.SUSPICIOUS_STEW);
    public static final Item FERMENTING_MILK_SPREAD = new SpreadItem(SpreadRegistry.FERMENTING_MILK);
    public static final Item POTION_SPREAD = new SpreadItem(SpreadRegistry.POTION);
    public static final Item GLOW_BERRY_JAM_SPREAD = new SpreadItem(SpreadRegistry.GLOW_BERRY_JAM);
    public static final Item MAYONNAISE_SPREAD = new SpreadItem(SpreadRegistry.MAYONNAISE);
    public static final Item SWEET_BERRY_JAM_SPREAD = new SpreadItem(SpreadRegistry.SWEET_BERRY_JAM);
    ...
    public static void init() {
        ...
        registerInternalItem(MUSHROOM_STEW_SPREAD, "mushroom_stew_spread");
        registerInternalItem(RABBIT_STEW_SPREAD, "rabbit_stew_spread");
        registerInternalItem(BEETROOT_SOUP_SPREAD, "beetroot_soup_spread");
        registerInternalItem(HONEY_SPREAD, "honey_spread");
        registerInternalItem(SUSPICIOUS_STEW_SPREAD, "suspicious_stew_spread");
        registerInternalItem(FERMENTING_MILK_SPREAD, "fermenting_milk_spread");
        registerInternalItem(POTION_SPREAD, "potion_spread");
        registerInternalItem(GLOW_BERRY_JAM_SPREAD, "glow_berry_spread");
        registerInternalItem(MAYONNAISE_SPREAD, "mayonnaise_spread");
        registerInternalItem(SWEET_BERRY_JAM_SPREAD, "sweet_berry_spread");
    }
